...
public final class Book extends Item
{
     ...
     * <p>
     * SIMPLE for 0 and HARD for 1 Intentionally we have avoided updating the constructors to avoid making the rest of the project dependent upon a very specific enum. So the constructor takes an int as an argument for the package.
     * <p>
     * The problem: what if I change the order of the enum values later? Everything is gonna be wrong
     * <p>
     * Also: what happens if the constructor takes sth other than an available int?
     *
     * @todo TODO For *you*: can you argue if this is the best possible setup?
     * <p>
     * Can *you* find a way to ensure that the rest of the system is intact and we avoid a dependency? Is it better this way? What price would you pay and what would you gain? (there is no silver bullet) Is it better -in the end- to just use a PackageType in the constructor and let everyone know?
     */
